...
const AppContent = () => {
	...
	const { navbarRef } = useGlobalStore();
	...
	return (
		<main className="min-h-screen bg-black-primary flex flex-col gap-2" >
			...
			<div >
				...
				<div className="block md:hidden fixed bottom-0 left-0 right-0 bg-black-secondary/85 backdrop-blur-2xl z-40 transition-all duration-200 ease-in-out" >
					<NavbarBottom />
				</div>
			</div>
		</main>
