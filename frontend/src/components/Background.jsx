const Background = ({ page }) => {
    return (
        <div className="absolute top-0 left-0 right-0 min-h-screen max-w-screen isolate overflow-hidden" >
            ...
            {/* image */}
            <div className=" absolute top-0 right-0 left-0 h-[80dvh] w-screen object-cover bg-top lg:bg-center z-10 " style={{ backgroundImage: `url(${page?.image})` , backgroundRepeat: 'no-repeat' , backgroundSize: '100%' }} ></div>
        </div>
    )
}
