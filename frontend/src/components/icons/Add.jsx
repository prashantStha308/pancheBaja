const Add = ({ className = "" , fill = "none", size = 60 , strokeWidth = 4 }) => {
  return (
    <svg className={`${className} hover:fill-red-primary`} width={size} height={size} viewBox="0 0 145 145" fill={fill}>
